...
<script>
	function result(zipNum, sido, gugun, dong, bunji){
		...
		opener.document.formm.zipcode.value=1;
		opener.document.formm.address.value=sido +" " + gugun + " "+dong+" "+bunji;
		self.close();
	}
...
<body>
	<h1> 우편번호 검색</h1>
	<form method=post name = formm action= "/wepapp/NonageServlet2?command=find_zip_num"> 
